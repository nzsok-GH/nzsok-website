...
const TERMS = [
  ...
  },
  {
    ...
    rows: [
      ...
      { week: 5, date: "8월 22일", event: "동화 발표회", type: "special" },
...
const SCHEDULE_INFO = [
  ...
  {
    title: "특강 수업 (선택)",
    time: "오후 1:50 ~ 오후 3:00",
    detail: "미술 · 4D프레임 · 태권도 · 바이올린",
  },
];
    ...
    <>
      ...
      <section id="schedule" style={{ marginBottom: 80 }}>
        ...
        <div className="education-schedule-grid">
          <div style={{ display: "flex", flexDirection: "column" }}>
            {SCHEDULE_INFO.map(({ title, time, detail }, i) => (
              <div
                key={title}
                style={{
                  padding: "16px 0",
              ...
              >
                ...
                <p style={{ color: "#4a5f75", fontSize: 16, lineHeight: 1.7 }}>
                  <strong style={{ color: "#1c2b3a" }}>{time}</strong>
                  <br />
                  {detail}
                </p>
              </div>
                  ...
                  <tr key={badge} style={{ background: i % 2 === 0 ? "#fff" : "#FDFCFA" }}>
                    <td
                      style={{
                        ...
                        borderRight: "1px solid rgba(0,0,0,0.05)",
                        textAlign: "center",
                        color: type === "lunch" ? "#8a9ab0" : "#4a5f75",
                        fontWeight: 600,
                      }}
                    >
                      {badge}
      ...
      <section id="programs" style={{ marginBottom: 80 }}>
        ...
        <div
          ...
          style={{
            background: "rgba(193,220,245,0.25)",
                ...
                {TERMS.map(({ label }) => [
                  ...
                  <th
                    ...
                    style={{
                      ...
                      borderBottom: "1px solid rgba(0,0,0,0.08)",
                      borderRight:
                        label !== "텀 4" ? "2px solid rgba(0,0,0,0.1)" : "none",
                    }}
                  >
                    일정
                  </th>,
